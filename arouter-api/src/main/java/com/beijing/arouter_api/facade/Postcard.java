package com.beijing.arouter_api.facade;
...
import com.beijing.arouter_api.facade.template.IProvider;
...
public final class Postcard extends RouteMeta {
    ...
    public Object navigation(Context context, NavigationCallback callback) {
        return ARouter.Companion.getInstance().navigation(context, this, -1, callback);
    }
    ...
    public void navigation(Activity mContext, int requestCode, NavigationCallback callback) {
        ARouter.Companion.getInstance().navigation(mContext, this, requestCode, callback);
    }
